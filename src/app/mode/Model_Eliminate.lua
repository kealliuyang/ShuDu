...
function Model_Eliminate:saveContinueGeneralData( putBlock,createBlock,score,refreshTimes )
...
function Model_Eliminate:saveContinueAdvancedData( putBlock,createBlock,score,refreshTimes )
